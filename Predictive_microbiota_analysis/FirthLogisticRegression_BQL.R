...
setwd("/home/ucm-user/Documentos/BQL_ANALYSIS/Predictive_microbiota_analysis/BQL")
...
# 3. LEER DATOS
data <- read.csv("Log2_micro_BQL_data.csv", row.names = 1)
...
lr_row <- data.frame(
  ...
  CI_low = NA,
  CI_high = NA,
  p_value = 3.346836e-07  # Del summary: "p=0.02082463"
)
